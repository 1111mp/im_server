...
module.exports = (sequelize, DataTypes) => {
	const DynaSource = sequelize.define('DynaSource',
		{
			id: {
	...
	DynaSource.associate = function (models) {
		DynaSource.belongsTo(models.Dynamic, { foreignKey: 'dynamicId', targetKey: 'id' })

		DynaSource.belongsTo(models.User, { foreignKey: 'userId', targetKey: 'id' })
	}
